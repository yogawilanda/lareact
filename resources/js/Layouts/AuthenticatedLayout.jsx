...
export default function Authenticated({ user, header, children }) {
    ...
    let userStatus = user.is_admin ? "Admin" : "User";

    return (
        <div className="min-h-screen overflow-auto bg-gray-100 dark:bg-gray-900">
            <nav className="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        ...
                        <div className="flex items-center text-2xl font-bold -me-2 sm:hidden dark:text-white">
                            <h1>Occupio</h1>
                        </div>
                    ...
                    {/* <button className="mx-2 md:flex lg:flex sm:flex">
                        a
                    </button> */}
                </div>
...
function DropDownDesktopInteractivity({ setShowingNavigationDropdown, showingNavigationDropdown }) {
    return <div className="flex items-center -me-2 sm:hidden">
        <button
...
function DropDownMenuDesktopView({ user }) {
